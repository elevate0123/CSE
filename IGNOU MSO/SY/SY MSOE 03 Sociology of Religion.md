...
```mermaid
graph TD
    subgraph A [Intellectual Context]
        A1[Rejection of Animism Tylor]
        A2[Rejection of Naturism Müller]
    end

    subgraph B [Core Theory]
        B1(Religion as a Social Fact) --> B2(Foundation: The Sacred-Profane Dichotomy);
        B2 --> B3(Case Study: Totemism);
        B3 --> B4(Insight: God = Society);
        B4 --> B5(Mechanism: Rituals & Collective Effervescence);
        B5 --> B6(Primary Function: Social Solidarity);
    end

    subgraph C [Modern Applications]
        C1[Civil Religion Bellah]
        C2[Sporting Events]
        C3[Political Rallies]
    end

    subgraph D [Critical Evaluation]
        D1[Weak Ethnography]
        D2[Ignores Conflict]
        D3[Lévi-Strauss's Critique]
        D4[Limited in Modernity]
    end
...
```mermaid
graph TD
    subgraph A [Foundation: Historical Materialism]
        A1(Economic Base: Mode of Production) --> A2(Ideological Superstructure);
        A2 --> A3(Religion is part of the Superstructure);
    end

    subgraph B [The Function of Religion in Class Society]
        B1[Root Cause: Alienation] --> B2[Symptom: Religion as Opium of the People];
        B2 --> B3[1 Painkiller for Oppression];
        B2 --> B4[2 Creates False Consciousness];
        B3 & B4 --> B5[Result: Legitimizes Ruling Class Domination];
    end

    subgraph C [The Future of Religion]
        C1(Proletarian Revolution) --> C2(End of Class Society & Alienation);
        C2 --> C3(Religion becomes unnecessary);
        C3 --> C4(The Withering Away of Religion);
    end

    subgraph D [Critical Evaluation]
        D1[Economic Reductionism]
        D2[Ignores Religion as a force for Change e.g., Liberation Theology]
        D3[Prediction of its decline has been falsified]
    end
...
```mermaid
graph TD
    subgraph A [The Puzzle & Method]
        A1[Why did rational capitalism emerge only in the West?]
        A2[Method: Verstehen & Ideal Types]
    end
    ...
    subgraph C [The Link: The Protestant Ethic]
        C1[Worldly Asceticism: Hard Work + No Luxury] --> C2[Systematic Accumulation of Wealth as a 'Sign' of Election];
    end
...
graph TD
    A[Modernity];
    A --> B{Secularization Thesis};
    A --> C{Rise of Religious Pluralism};

    subgraph Secularization
        B1[1. Societal Differentiation]
        B2[2. Decline of Practice]
        B3[3. Privatization of Belief]
    end
    ...
    subgraph Revival
        D1[Fundamentalism: A Modern Reaction]
        D2[Key Features: Inerrancy, Selective Modernity, Manichaeism]
        D3[Indian Context: Communalism]
    end

    B --Is Critiqued as--> E{Critique};
    subgraph Critique
        E1[Eurocentric]
...
graph TD
    ...
    subgraph B [The Functionalist Analysis]
        B1("Magic (Instrumental, Coercive, Individual)")
        B2("Religion (Expressive, Supplicatory, Collective)")
        B3("Myth (A 'Social Charter')")
        B4("Ritual (The 'Performance' of Belief)")
    end
...
```mermaid
graph TD
    subgraph A [The Context: 6th Century BCE Gangetic Plains]
        A1[Economic Change: Second Urbanization, Iron Plough, Trade Surplus]
        A2[Political Change: Rise of Mahajanapadas, Kshatriya Ambition]
        A3[Religious Change: Crisis in Vedic Brahmanism, Upanishadic thought]
    end
    ...
    subgraph C [The Buddhist Solution]
        C1[Rejection of Caste & Ritual -> Appeals to Vaishyas & Shudras]
        C2[Doctrine of Ahimsa -> Supports new agrarian economy]
        C3[Use of Pali Language -> Democratizes knowledge]
        C4[Royal Patronage -> Political support]
        C5[The Sangha -> A new, egalitarian social model]
    end

    A --> B;
    B --> C;
    C --> D[Emergence of Buddhism as a Major World Religion];
```
...
```mermaid
graph TD
    subgraph A [The Core Driver: Caste Oppression]
        A1[Ritual Stigma & Social Degradation] --> A2[Search for Dignity & Equality];
    end
    ...
    subgraph D [Other Sociological Aspects]
        D1[Relative Deprivation]
        D2[Role of Social Networks]
        D3[Cultural Syncretism]
    end
...
graph TD
    ...
    subgraph D [Theory 3: The Structuralist School]
...
```mermaid
graph TD
    subgraph A [The Core Question: What is Religion's Role in Society?]
    end

    subgraph B [Durkheim's Functionalist Lens]
        B1[Function: Social Integration]
        B2[Social Change: A Force for Stability]
        B3[Future: Transformation into Civil Religion]
    end

    subgraph C [Marx's Conflict Lens]
        C1[Function: Class Domination Opium]
        C2[Social Change: A Barrier to Revolution]
        C3[Future: Disappearance Wither Away]
    end

    subgraph D [Weber's Interpretive Lens]
        D1[Function: Providing Meaning Theodicy]
        D2[Social Change: A Potential Catalyst Prophets]
        D3[Future: Disenchantment Iron Cage]
    end
