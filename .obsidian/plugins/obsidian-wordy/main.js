...
var DatamuseApi = class {
  ...
  async wordsSpelledLike(rootWord) {
  ...
  async relatedWords(queryParam, rootWord) {
    ...
    try {
      ...
      new import_obsidian.Notice(`DatamuseAPI \u2014 ${error}.`);
      return [];
    }
  }
};
...
function add_css(target) {
  append_styles(target, "svelte-ipj1f0", ".search-container.svelte-ipj1f0{margin:8px}.search-input.svelte-ipj1f0{width:100%}.search-results.svelte-ipj1f0{margin-top:16px;display:grid;gap:4px;grid-template-columns:repeat(auto-fill, minmax(150px, 1fr))}.search-result.svelte-ipj1f0{padding:4px;border:1px solid #ccc;border-radius:4px;display:grid;align-items:center;justify-content:center}");
}
...
function create_if_block(ctx) {
  ...
  return {
    c() {
      ...
      attr(div, "class", "search-results svelte-ipj1f0");
    },
    m(target, anchor) {
...
function create_each_block(ctx) {
  let div;
  let strong;
  let t0_value = ctx[6].term + "";
  let t0;
  let t1;
  let t2_value = ctx[6].definition + "";
  let t2;
  let t3;
  return {
    c() {
      ...
      t2 = text(t2_value);
      t3 = space();
      attr(div, "class", "search-result svelte-ipj1f0");
    },
    m(target, anchor) {
      insert(target, div, anchor);
      append(div, strong);
    ...
    p(ctx2, dirty) {
      if (dirty & 2 && t0_value !== (t0_value = ctx2[6].term + ""))
        set_data(t0, t0_value);
      if (dirty & 2 && t2_value !== (t2_value = ctx2[6].definition + ""))
...
function create_fragment(ctx) {
  ...
  return {
    c() {
      ...
      attr(input, "class", "search-input svelte-ipj1f0");
      attr(input, "placeholder", "Search");
      attr(div, "class", "search-container svelte-ipj1f0");
    },
    m(target, anchor) {
      insert(target, div, anchor);
      append(div, input);
...
function instance($$self, $$props, $$invalidate) {
  const toSearchResult = (term) => ({ term, definition: "" });
  let searchTerm = "";
  let searchResults = [];
  const debouncedSearch = (0, import_lodash.debounce)(() => __awaiter(void 0, void 0, void 0, function* () {
    const dm = new DatamuseApi();
    $$invalidate(1, searchResults = (yield dm.wordsSimilarTo(searchTerm)).map(toSearchResult));
  }), 300);
  ...
  return [searchTerm, searchResults, handleInputChange, input_input_handler];
}
...
var WordyPlugin = class extends import_obsidian2.Plugin {
  ...
  async onload() {
    ...
    this.registerView(VIEW_ID, (leaf) => new WordyView(leaf));
      ...
      editorCallback: async (editor, view) => {
        ...
        if (rootWord != "") {
          ...
          if (similarWords.length == 0) {
            new import_obsidian2.Notice(`Oops \u2014 No synonyms found.`);
            return;
          }
          ...
          new import_obsidian2.Notice(`Oops \u2014 Select a word first.`);
        }
      }
    });
    this.addCommand({
      ...
      editorCallback: async (editor, view) => {
        ...
        if (rootWord != "") {
          ...
          if (oppositeWords.length == 0) {
            new import_obsidian2.Notice(`Oops \u2014 No antonyms found.`);
            return;
          }
    ...
    this.addCommand({
      ...
      editorCallback: async (editor, view) => {
        ...
        if (rootWord != "") {
          ...
          if (rhymes.length == 0) {
            new import_obsidian2.Notice(`Oops \u2014 No rhymes found.`);
            return;
          }
  ...
  async activateView() {
    ...
    this.app.workspace.revealLeaf(this.app.workspace.getLeavesOfType(VIEW_ID)[0]);
  }
  async loadSettings() {
...
var VIEW_ID = "wordy-view";
var WordyView = class extends import_obsidian3.ItemView {
  constructor(leaf) {
    super(leaf);
  }
  getViewType() {
...
var SearchableWordsModal = class extends import_obsidian2.SuggestModal {
...
var WordyPluginSettingTab = class extends import_obsidian2.PluginSettingTab {
